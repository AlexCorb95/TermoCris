...
class UserExtendForm(UserCreationForm):
    class Meta:
        model = UserExtend
        fields = ['first_name', 'last_name', 'username', 'date_of_birth', 'email', 'email_confirmation', 'phone_number']
        ...
        widgets = {
            ...
            'phone_number': TextInput(attrs={'placeholder': 'Enter your phone number', 'class': 'form-control'}),
        }
